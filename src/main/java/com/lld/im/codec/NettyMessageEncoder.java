...
// * @author: Chackylee
// * @description:
// * @create: 2022-04-27 11:48
// **/
//public class NettyMessageEncoder extends MessageToByteEncoder<JSObject> {
//
//    @Override
//    protected void encode(ChannelHandlerContext ctx, JSObject message, ByteBuf sendBuf) throws Exception {
