...
public class CheckFriendShipResp {
    ...
    //单向校验：1 from添加了to，不确定to是否添加了from CheckResult_singe_Type_AWithB；0from没有添加to，也不确定to有没有添加from CheckResult_singe_Type_NoRelation
    ...
    //单向校验黑名单：1 from没有拉黑to，不确定to是否拉黑了from CheckResult_singe_Type_AWithB；0 from拉黑to，不确定to是佛拉黑from CheckResult_singe_Type_NoRelation
